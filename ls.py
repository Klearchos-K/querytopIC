...
class Graph():
    ...
    def construct_tree2222222(self, cvs, r, g):
        ...
        for vertex in self.IT[r]:
            ...
            for u2 in sorted(vertex.value):
                u = self.Gr[u2.id]
                if u.id == '4017':
                    print("jehgiurhengjrhbgurwhio;ghinbioawrnghiwrhgionwhgnw")
                    print(u.neighbours2)
                    print(u.vertex_p[2].childs)
                #print(sorted(g[u2.id].getN()))
                #for v in (g[u2.id].neighbours2):
                for v in sorted(g[u2.id].neighbours2, reverse=True):
                    ...
                    if Su != Sv:
                        ...
                        if Su.minweight < Sv.minweight:
                            ...
                            Sv.parent = Su
                            #if u.id == '4017':
                            print("ebala paidi", Sv, 'sto ', Su, ' apo ', u)

                        else:
                            Sv.childs.append(Su)
                            Su.parent = Sv
                            #if u.id == '4017':
                            print("--ebala paidi", Su, 'sto ', Sv, ' apo ', u)
        print(self.IT[r][10])
    ...
    def expreriments(self, num=100):
        ...
        print("ONLINE TIME: ", t1, self.time_copy)
        print("MY TIME (OUR TIME): ", t2, fo)
        print("Ratio: ", t1/t2)
...
foo = Graph()
#foo.load_part('youtube.txt', '\t', part=50)
foo.load('youtube.txt', '\t')
...
# for i in range(3, 4):
#     re1 = foo.local_search_only(150, 2)
#     foo.query(12, 2)
#     foo.query(54, 2)
#     re2 = foo.query(150, 2)
#     #print(re1)
#     #print(re2)
#     print(check_correctness(re1, re2))
#     print(len(re1), len(re2))
#
# exit(0)
#foo.load('DBLP.txt', '\t')
